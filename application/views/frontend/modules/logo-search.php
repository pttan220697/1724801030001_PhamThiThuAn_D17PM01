<section class="logo-search">
  <div class="container">
    <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 logo">
      <a href="<?php echo base_url() ?>"><img src="<?php echo base_url() ?>public/images/logoweb.png" alt="Logo Construction"></a>
    </div>
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-5 search">
      <div class="contact-row">
        <div class="phone inline">
         <a href="tel:0388918413"> <img src="<?php echo base_url() ?>public/images/call.gif"  style="width: 20px">  (+84) 0388918413</a>
        </div>
        <div class="contact inline">
          <a href="mailto:pttan220697@gmail.com"><img src="<?php echo base_url() ?>public/images/gmail.gif"  style="width: 30px"> pttan220697@gmail.com</a>
        </div>
      </div>
      ...
      <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12 hidden-xs" style="padding: 25px;">
       <!-- Cart -->
   ...
   <div class="user_login">
     <a href="thong-tin-khach-hang" title="Tài khoản">
      <div class="user_login_icon">
       <img src="<?php echo base_url() ?>public/images/user.gif" style="width: 70%">
     </div>
     <div class="box_text">
