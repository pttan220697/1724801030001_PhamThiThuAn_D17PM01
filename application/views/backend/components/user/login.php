<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
            <img src="<?php echo base_url() ?>public/images/logoweb.png"width=95% >
            </div>
            <hr>
            <div class="myform">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2020 <a href="#" style="color:red">E-commerce</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
