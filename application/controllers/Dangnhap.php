...
class Dangnhap extends CI_Controller {
    ...
    public function dangky(){
        ...
        if($this->form_validation->run() ==TRUE){
            ...
            $this->email->message('Bạn đã trở thành thành viên mới của cửa hàng Didongsmart, Cửa hàng tặng bạn 1 mã giảm giá giảm 100.000 vnđ : '.$tempcoupon.' , Mã này có giá trị tới ngày '.$tempdatelimit.'
